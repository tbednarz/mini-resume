...
const MiddleThird = () => {
	...
	return (
		<div id="middle-third-box">
			<div id="column">
				<input id="column-header" value={firstColumnHeader} onInput={changeFirstColumnHeader} />
				<textarea
					id="column-info"
					value={firstColumnInfo}
					onInput={firstColumnInfoChange}
